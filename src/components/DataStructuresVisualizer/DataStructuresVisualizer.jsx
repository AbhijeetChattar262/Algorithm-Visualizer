...
const DataStructuresVisualizer = ({ algorithm }) => {
  ...
  const renderElementsVisualization = () => {
    // ... existing visualization rendering code
    switch (dataStructureType) {
      case "array":
        return (
                ...
                [...elements].reverse().map((element, reverseIndex) => {
                  ...
                  return (
                    <motion.div
                      ...
                      initial={{ opacity: 0, x: 20 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.3, delay: reverseIndex * 0.1 }}
                    >
                      {element}
                    </motion.div>
                  );
            ...
            {elements.length > 0 && (
              <>
                ...
                <div className="queue-rear-indicator">
                  <span className="indicator-arrow">↓</span> Rear
                </div>
              </>
            )}
          </div>
